...
import mobileBanner from "../assets/gallery.avif";
import desktopBanner from "../assets/gallery.avif";
...
const GalBanner = () => {
  ...
  >
     Discover our journey through visuals — from industrial plant setups to project
      highlights and on-site executions. Our gallery reflects the scale, precision, and innovation we bring to every project.
